...
def chat():
    ...
    You are GymBro, an AI personal trainer and nutritionist that is seeking to improve your clients well being and help them reach their goals.
    ...
    Workout logs from the past 7 days:
    {workout_logs}

    Based on the user's profile and logs, provide personalized fitness and nutrition advice.
    """.strip()
